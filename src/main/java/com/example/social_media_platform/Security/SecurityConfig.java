    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("v0/auth/login", "v0/auth/register", "/swagger-ui.html", "/v3/api-docs/**", "/swagger-resources/**", "/swagger-ui/**", "/webjars/**", "v0/post/AddPost").permitAll() // Publicly accessible endpoints
